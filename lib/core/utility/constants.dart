...
class Constants {
  ...
  static Future<void> showConfirmPopup(
      BuildContext rootContext, double height, double width) async {
    await showDialog(
      context: rootContext,
      builder: (context) {
  ...
  // static void showPrescriptionOnboarding(
  //     BuildContext rootContext, double height) {
  ...
  //     context: rootContext,
  //     builder: (context) {
  //       return PrescriptionOnboardingView(height: height);
  //     },
  //   );
  // }
  ...
  static const String labTestDesc =
      "A medical procedure used to detect and identify bacteria or other microorganisms present in the bloodstream.";
  static const String drugDescription =
      "Trusted medication for health and treatment of various conditions";
  static const drugImageHolder =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjiQpm2v90LJYAoXv2n10gHJpiW2L_i96PYQ&usqp=CAU";
  static const pharmacyImageHolder =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpqImCUtB--eF6Td_WDw9t55HK_4sWUTgGHA&usqp=CAU";
}
