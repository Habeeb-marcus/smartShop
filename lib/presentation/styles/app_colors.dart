...
class AppColors {
  ...
  static const Color black4 = Color(0xFFEEEEEE);
  static const Color black5 = Color(0xff111827);
  ...
  static const Color orange = Color(0xffff8160);
  ...
  static Color blackOrWhite(BuildContext context) {
    if (Theme.of(context).brightness == Brightness.dark) return white;
    return black;
  }

  static Color greyOrWhite(BuildContext context) {
    if (Theme.of(context).brightness == Brightness.dark) return white;
    return textGray;
  }

  static Color dynamicLightGray(BuildContext context) =>
